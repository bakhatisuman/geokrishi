package com.geokrishifarm.crop_health_query.repo
...
import com.geokrishifarm.crop_health_query.retrofit.ProgressRequestBody
import com.geokrishifarm.crop_health_query.retrofit.APIService
import com.geokrishifarm.crop_health_query.retrofit.NetworkModule
import com.geokrishifarm.crop_health_query.retrofit.RetroHelper
import com.geokrishifarm.crop_health_query.utils.NetworkUtils
    ...
    companion object{
        ...
        fun provideCropHealthRepo(context: Context) : CropHealthRepo {
            return repo ?: synchronized(this){
                repo
                    ?: CropHealthRepo(context , NetworkModule.getInstance().provideApiService(context)).also {
                    repo = it
                }
            }
        }
